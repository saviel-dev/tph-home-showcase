...
const PackageSearch = createLucideIcon("package-search", __iconNode$c);
const __iconNode$b = [
  [
    "path",
    {
...
const SlidersHorizontal = createLucideIcon("sliders-horizontal", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
